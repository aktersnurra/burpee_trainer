          ...
          >
            ...
            <div class="rounded-xl border border-[var(--session-border)] bg-[var(--session-track)]/30 p-3 space-y-3">
              ...
              <textarea
                ...
                readonly
                class="min-h-32 w-full rounded-xl border border-[var(--session-border)] bg-[var(--session-surface)] p-2 text-[10px] text-[var(--session-muted)]"
              >[]</textarea>
            </div>

            <div class="rounded-xl border border-[var(--session-border)] bg-[var(--session-track)]/30 p-3">
              <p class="text-sm font-medium text-[var(--session-muted)]">Cadence</p>
