const CALIBRATION_EVENT = "pose-debug:start-calibration";

const PoseCalibrationButton = {
	mounted() {
		this.started = false;
	...
	start(event) {
		...
		this.el.textContent = "Tap received";
		document
			.querySelector("#pose-debug")
			?.dispatchEvent(new CustomEvent(CALIBRATION_EVENT, { bubbles: true }));
	},
};

export default PoseCalibrationButton;
