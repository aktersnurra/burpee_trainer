# Intelligence Layer Refactor Spec

Apply on top of `SPEC.md`. This replaces the previous `ScheduleSolver` direction and refactors the intelligence layer around a fixed weekly training contract, coach target suggestions, and a simpler session planner.
